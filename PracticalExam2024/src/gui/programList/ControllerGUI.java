...
public class ControllerGUI {
    ...
    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> latchLocationColumnView;
    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> latchValueColumnView;
    @FXML
    ...
    public void initialize() {
        ...
        latchLocationColumnView.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().first).asObject());
        latchValueColumnView.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().second).asObject());
    }
   ...
   {
       PrgState currentProgramState = this.getCurrentProgramState();
       ILatchTable latchTable = Objects.requireNonNull(currentProgramState).getLatchTable();
       ArrayList<Pair<Integer, Integer>> latchEntries = new ArrayList<>();

        //we use Map.Entry because we need to iterate through the key-value pairs of the latchTable
